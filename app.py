...
# convert the labeled geography into numerical values
geo_geography = label_encoder_geo.transform([[geography]]).toarray()
geo_encoded_df = pd.DataFrame(geo_geography,columns=label_encoder_geo.get_feature_names_out(['Geography']))
